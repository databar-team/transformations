...
CASE joha.context WHEN 'SAPC' THEN SUBSTR (joha.attribute2, 1, (STRPOS (joha.attribute2, '-') - 1)) ELSE NULL END as PHOTOGRAPHER_NUMBER,

CASE joha.context WHEN 'SAPC' THEN SUBSTR (joha.attribute2, (STRPOS (joha.attribute2, '-') + 1), LENGTH(joha.attribute2)) ELSE NULL END as PHOTOGRAPHER_NAME,
